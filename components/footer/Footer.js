        ...
        <div className="grid grid-cols-12 lg:gap-6 pt-16">
            ...
            <ul>
                {footer_content.column_three.map((item, index) => (
                    ...
                    <button className="w-1/2 mt-10 font-din tracking-wider text-[18px] mb-52 uppercase bg-chinoorange text-chinodarkblue border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium">
                        Store Locator
                    </button>
            </div>
        </div>
