                ...
                <div className="mb-2 px-8 xl:px-0">
                    <BlocksControls index={props.index}>
                        <div className="text-center py-8 lg:py-16">
                            <a href={data.link.url} className="px-5 py-2 bg-chinored text-white uppercase font-din font-bold text-xl lg:text-4xl rounded-lg tracking-wide">{data.button.text}</a>
                        </div>
                    </BlocksControls>
                </div>
            </div>
